...
//		HashMap<Section, ArrayList<String>> roster = new HashMap<>();
		MyHashMap<Section, ArrayList<String>> roster = new MyHashMap<>();
	...
	public static void registerAStudent(MyMap<Section, ArrayList<String>> roll, Section s, String student) {
