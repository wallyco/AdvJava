...
public class MyHashMapBook<K, V> implements MyMap<K, V> {
	...
	public LinkedList<MyMap.Entry<K, V>>[] getTable() {
		return table;
	}

	/** Construct a map with the default capacity and load factor */
	public MyHashMapBook() {
	 ...
	 */
	public MyHashMapBook(int initialCapacity) {
	...
	public MyHashMapBook(int initialCapacity, float loadFactorThreshold) {
